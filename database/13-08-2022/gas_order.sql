...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2022 at 04:55 PM
...
CREATE TABLE `barang_rusak` (
  ...
  `tanggal_penempatan` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `barang_rusak` (`id_barang_rusak`, `id_barang`, `jumlah`, `tanggal_penempatan`) VALUES
(3, 2, 2, '2022-08-13 21:48:19'),
(4, 5, 4, '2022-08-13 21:54:07');
...
(18, 'pimpinan1', 'e10adc3949ba59abbe56e057f20f883e', NULL, 'Aktif', 'Pimpinan satu', 3);
...
--
ALTER TABLE `barang_rusak`
  MODIFY `id_barang_rusak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
