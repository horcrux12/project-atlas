            ...
            <div class="card-box">
                ...
                <div class="inbox-widget slimscroll" style="max-height: 360px;">
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?php echo base_url();?>assets/images/users/avatar-1.jpg"
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?php echo base_url();?>assets/images/users/avatar-3.jpg"
                                    class="rounded-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?php echo base_url();?>assets/images/users/avatar-4.jpg"
                                    class="rounded-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?php echo base_url();?>assets/images/users/avatar-5.jpg"
                                    class="rounded-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?php echo base_url();?>assets/images/users/avatar-6.jpg"
                                    class="rounded-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?php echo base_url();?>assets/images/users/avatar-8.jpg"
                                    class="rounded-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?php echo base_url();?>assets/images/users/avatar-9.jpg"
                                    class="rounded-circle" alt=""></div>
                ...
                <div class="table-responsive">
                    <table class="table table table-hover m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>
                                    <img src="<?php echo base_url();?>assets/images/users/avatar-7.jpg" alt="user"
                                        class="avatar-sm rounded-circle" />
                                </th>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <img src="<?php echo base_url();?>assets/images/users/avatar-8.jpg" alt="user"
                                        class="avatar-sm rounded-circle" />
                                </th>
                                <td>
